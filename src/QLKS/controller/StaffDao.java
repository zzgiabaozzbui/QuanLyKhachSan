...
public class StaffDao implements Dao<staff>{
    ...
    public List<staff> getAll() {
        ...
        try {
            ...
            while (rs.next()) {                    
                ...
                list.add(new staff(maNV, maBP, TenNV, NS, GT, SDT, CMND, Email, DC));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public List<staff> getNV() {
        ...
        try {
            ...
            while (rs.next()) {                    
                ...
                list.add(new staff(maNV, "a", TenNV, "", 0, "", "", Email, DC));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public int update(staff t) {
        try {
            String sql_update = "UPDATE "+TABLE_NAME+" SET  "+MABOPHAN_FIELD+" = ?, "+TENNV_FIELD+" = ?, "+NGAYSINH_FIELD+" = ?, "+GIOITINH_FIELD+" = ?, "+SDT_FIELD+" = ?, "+CMND_FIELD+" = ?, "+EMAIL_FIELD+" = ? ,"+DIACHI_FIELD+" = ? WHERE "+MANV_FIELD+" = ?";
