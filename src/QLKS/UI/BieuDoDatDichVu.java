 ...
 * @author ADMIN
 */
public class BieuDoDatDichVu extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public BieuDoDatDichVu() {
        initComponents();
    ...
    private static JFreeChart createChart(PieDataset dataset) {
        JFreeChart chart = ChartFactory.createPieChart(
                "Đặt dịch vụ", dataset, true, true, true);
        return chart;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BieuDoDatDichVu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BieuDoDatDichVu().setVisible(true);
            }
        });
    }
